...
// requiredItems: 5
// items: Array(9)
// 0: {name: "Morel", key: "Morel_Exotic Foraging", amount: 1, spring: true, summer: true, …}
// 1: {name: "Pine Tar", key: "Pine Tar_Exotic Foraging", amount: 1, spring: true, summer: true, …}
// 2: {name: "Cave Carrot", key: "Cave Carrot_Exotic Foraging", amount: 1, spring: true, summer: true, …}
// 3: {name: "Purple Mushroom", key: "Purple Mushroom_Exotic Foraging", amount: 1, spring: true, summer: true, …}
// 4: {name: "Maple Syrup", key: "Maple Syrup_Exotic Foraging", amount: 1, spring: true, summer: true, …}
// 5: {name: "Coconut", key: "Coconut_Exotic For
...
//   console.log(name, reward, roomBundles);
// }
      ...
      bundles: roomBundles.map(bundle => {
        ...
        return {
          ...
          items: bundleItems.map(item => {
            ...
            if (_.find(bundleItems, { name })) {
              key += `_${_.countBy(bundleItems, { name }).true}`;
            }
